...
type RuleOption = { id: string; title: string; group: string };

// Put your full rule list here when ready.
// For now this keeps it functional.
const RULES: RuleOption[] = [
  { group: "1. General Rules", id: "1.3", title: "Cheating / Hacking" },
  { group: "3. In-Game Rules", id: "3.10", title: "RDM" },
  { group: "12. Metagaming", id: "12.1", title: "Using OOC Information IC" },
];
...
export default function CaseEditor({ initial }: { initial: any }) {
  ...
  async function save() {
    ...
    try {
      ...
      // Optional: route back to view after save
      // window.location.href = `/cases/${initial.id}`;
      alert("Saved");
    } finally {
      setSaving(false);
    }
